      ...
      <div class="col-lg-8">
        <div class="card shadow-lg">
          ...
          <div class="card-tabs">
            <button
              class="card-tab"
              :class="{ 'card-tab--active': activeTab === 'individual' }"
              @click="activeTab = 'individual'"
            >
              <i class="bi bi-person me-2"></i>Alta individual
            </button>
            <button
              class="card-tab"
              :class="{ 'card-tab--active': activeTab === 'masiva' }"
              @click="activeTab = 'masiva'"
            >
              <i class="bi bi-people me-2"></i>Alta masiva
            </button>
          </div>
        ...
        <div class="alert alert-info mt-4">
          ...
          <small
            >Al dar de alta, el javer se tendrá que registrar al sistema como usuario él
            mismo.</small
          >
        </div>
      </div>
